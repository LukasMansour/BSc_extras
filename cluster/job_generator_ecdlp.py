...
for choice in choice_metrics:
    for n in n_list:
        for width in widths:
            ...
            jobs.append((n, f"/home/{username}/.conda/envs/qc/bin/python3 {path}/dlp_ba/resource_estimation/resource_estimation_ecdlp.py {n} {choice} {seed} {width} /home/{username}/ba_resource_estimates/results_ecdlp/{width}_width/"))
current_node = 0
